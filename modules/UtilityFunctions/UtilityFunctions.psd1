...
Copyright = '(c) 2023 Pavel Stsefanovich. All rights reserved.'
...
FunctionsToExport = 'newline', 'error', 'info', 'warning', 'request-consent', 'wait-any-key', 
               ...
               'get-dotnet-fwk-version', 'get-fqdn', 'battery-report', 'wifi-profiles'
...
AliasesToExport = 'lf', 'confirm', 'jth', 'sstp', 'isrp', 'hib', 'wait', 'fwt', 'listmc', 'sql', 'run', 
               'unzipf', 'listis', 'dsort', 'unb', 'netfwk', 'fqdn', 'batt', 'wfp'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = 'Added functions battery-report, wifi-profiles'
