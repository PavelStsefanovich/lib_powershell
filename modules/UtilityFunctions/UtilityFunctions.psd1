...
FunctionsToExport = 'newline', 'error', 'info', 'warning', 'request-consent', 'wait-any-key',
               ...
               'get-dotnet-fwk-version', 'get-fqdn'
...
AliasesToExport = 'lf', 'confirm', 'jth', 'sstp', 'isrp', 'hib', 'wait', 'fwt', 'listmc', 'sql', 'run',
               'unzipf', 'listis', 'dsort', 'unb', 'netfwk', 'fqdn'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '1.Rmoved mandatory requirement from <outfile> parameter in run-sql(); 2.Added function get-fqdn'
